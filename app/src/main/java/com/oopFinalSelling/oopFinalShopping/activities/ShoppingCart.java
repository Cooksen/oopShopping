...
import com.oopFinalSelling.oopFinalShopping.MainActivity;
import com.oopFinalSelling.oopFinalShopping.R;
import com.oopFinalSelling.oopFinalShopping.adapters.ShoppingCartListAdapter;
...
public class ShoppingCart extends AppCompatActivity implements ShoppingCartListAdapter.UpdatePayableAmount, ShoppingCartListAdapter.MonitorListItems {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final List<Cart> shoppingCart = db_handler.getCartItems(dataManager.getData(Constants.SESSION_EMAIL));
        ...
        placeOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db_handler.insertOrderHistory(shoppingCart, dataManager.getData(Constants.SESSION_EMAIL));
...
//            Double tax = shoppingCart.get(i).getProduct().getTax().getValue();
        ...
        payable.setText("$ "+formatter.format(totalAmount));
    }
