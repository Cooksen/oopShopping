...
import static com.oopFinalSelling.oopFinalShopping.utils.Util.formatDouble;
...
public class DB_Handler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "ShOOP";
...
//            + TAX_VALUE + " REAL NOT NULL,"
    ...
    // Insert Products
    public void insertProducts(int id, int cat_id, String name, String date) {
        SQLiteDatabase db = this.getWritableDatabase();
