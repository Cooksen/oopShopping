...
//        holder.tax = rowView.findViewById(R.id.tax);
        ...
        holder.color.setText("顏色: " + shoppingCart.get(position).getVariant().getColor());
        ...
        holder.qty.setText(String.valueOf("數量: "+quantity[0]));
        holder.price.setText("$ " + Util.formatDouble(calculatePrice(0.0, priceValue, quantity[0])));
