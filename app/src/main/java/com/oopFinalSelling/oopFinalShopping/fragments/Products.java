...
import com.oopFinalSelling.oopFinalShopping.adapters.FilterItemListAdapter;
import com.oopFinalSelling.oopFinalShopping.adapters.ProductListAdapter;
import com.oopFinalSelling.oopFinalShopping.adapters.SortItemListAdapter;
...
import com.oopFinalSelling.oopFinalShopping.interfaces.ShowBackButton;
import com.oopFinalSelling.oopFinalShopping.interfaces.ToolbarTitle;
...
public class Products extends Fragment {
    ...
    TextView sortByText;
    String[] sortByArray = {"最近上傳", "最多訂單", "最多分享", "最多查看"};
    ...
    public void onResume() {
        ...
        try {
            ...
            List<Product> productList = db_handler.getProductsList(sortById, sizeFilter, colorFilter, cat_id, dataManager.getData(Constants.SESSION_EMAIL));
    ...
    private void fillGridView() {
        dataManager dataManager = new dataManager(getActivity());
        DB_Handler db_handler = new DB_Handler(getActivity());
        productList = db_handler.getProductsList(sortById, sizeFilter, colorFilter, cat_id, dataManager.getData(Constants.SESSION_EMAIL));
